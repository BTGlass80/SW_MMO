...
| --- | --- | --- | --- |
| Micro Tri Droid Stalker v2 | hostile droid fighter token; flatter tri-wing predator silhouette with larger eye and clearer threat prongs | [bbmodel](blockbench/micro_tri_droid_stalker_v2.bbmodel) | ![Micro Tri Droid Stalker v2](previews/micro_tri_droid_stalker_v2.png) |
