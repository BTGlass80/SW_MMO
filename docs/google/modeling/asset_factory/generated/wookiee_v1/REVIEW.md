...
| `torso_mesh` | 202 | 1616 |
| `head_mesh` | 120 | 1120 |
| `left_upper_arm_mesh` | 20 | 40 |
| `left_forearm_mesh` | 20 | 40 |
| `right_upper_arm_mesh` | 20 | 40 |
| `right_forearm_mesh` | 20 | 40 |
| `left_thigh_mesh` | 36 | 108 |
| `left_shin_mesh` | 36 | 108 |
| `right_thigh_mesh` | 36 | 108 |
| `right_shin_mesh` | 36 | 108 |
| `blaster_mesh` | 52 | 208 |
