...
| --- | --- | --- | --- |
| Micro ARC Interceptor Panel v2 | same ARC-style friendly ship silhouette as v1, with Minecraft-like surface panel detail only | [bbmodel](blockbench/micro_arc_interceptor_panel_v2.bbmodel) | ![Micro ARC Interceptor Panel v2](previews/micro_arc_interceptor_panel_v2.png) |
