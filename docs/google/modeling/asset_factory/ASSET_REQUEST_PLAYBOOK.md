...
The runtime proof adds the current production-shaped target: 439 walkable pixels merged to 40 walk rectangles, 527 blocker pixels merged to 38 collision shapes, 12 named sockets, socket-to-walk-cell resolution, and grid-routed actor probes. Use this as the model for room requests that need gameplay affordances as well as visual massing.
