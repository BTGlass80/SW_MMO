...
### E2 — Restore WEG cumulative wound ladder + Wounded-Twice  [STATUS: OPEN] [PAR] [rules] [M] (ledger-first)
...
### E3 — Wound recovery / healing model  [STATUS: OPEN] [PAR] [rules] [M] (depends E2)
...
### E5 — Weapon-driven range bands  [STATUS: OPEN] [PAR*] [rules] [M] (ledger-first; *edits d6_rules.gd — serialize with other d6_rules edits)
...
### E6 — Default-off Force-skill data hook  [STATUS: OPEN] [PAR*] [rules] [M] (ledger-first; *edits chargen_model.gd)
...
### E7 — `get_effective_security` single combat gate  [STATUS: OPEN] [PAR] [world-sim] [M]
...
### E8 — Pending-zone-influence accrual model  [STATUS: OPEN] [PAR] [world-sim] [M]
...
### E9 — Org membership + claim-command validator  [STATUS: OPEN] [PAR] [world-sim] [M]
