...
| --- | --- | --- | --- |
| Cantina Entrance Threshold Detail 01 | terrain_module | finer-detail elevated no-droids entrance threshold | ![Cantina Entrance Threshold Detail 01](captures/assets/cantina_entrance_threshold_detail_01.png) |
